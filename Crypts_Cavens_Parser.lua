...
function Crypts_Cavens_Parser:svg_to_map(svg_data)
	--Crypts_Cavens_Parser:create_map()
...
function Crypts_Cavens_Parser:new(map_id)
	self.__index = self
	...
	self.width = 500
	self.height = 500
	self.token_data = Maps[tostring(map_id)]
